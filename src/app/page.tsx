              ...
              <div className="flex flex-col justify-center space-y-4 text-center lg:text-left">
                <div className="space-y-2">
                  <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl font-headline">
                    <span className="bg-gradient-to-r from-primary via-accent to-secondary-foreground bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Convert PDF Tables to Excel</span> with <span className="bg-gradient-to-r from-primary via-accent to-secondary-foreground bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">AI.</span> <span className="text-primary">Securely.</span>
                  </h1>
